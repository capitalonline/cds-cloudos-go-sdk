...
type RetryPolicy interface {
	ShouldRetry(CdsError, int) bool
	GetDelayBeforeNextRetryInMillis(CdsError, int) time.Duration
}

// NoRetryPolicy just does not retry.
type NoRetryPolicy struct{}

func (_ *NoRetryPolicy) ShouldRetry(err CdsError, attempts int) bool {
	return false
}

func (_ *NoRetryPolicy) GetDelayBeforeNextRetryInMillis(
	err CdsError, attempts int) time.Duration {
...
func (b *BackOffRetryPolicy) ShouldRetry(err CdsError, attempts int) bool {
